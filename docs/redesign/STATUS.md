...
| 07 Performance screens | **07A done; 07B partly done** | `reports/07-d03-d08-ranking-and-pace.md` (merged), `07A-model-home-and-orders.md`. D03 and D08 shipped the Ranking board and the maintainer's weekly-pace column, both part of 07B. 07A put code uses on her Home and verified the rest. **What 07B still owes: the owner's Home - sales, pay forecast breakdown, active count, top three - and product analytics** |
